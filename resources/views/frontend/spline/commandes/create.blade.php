        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"> Ajouter une commande</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form" >
               {{ Form::open(['route' => 'frontend.commandes.store', 'id' => 'commandeModel','class' => 'form-horizontal', 'files' => true, '@submit' => 'submit']) }}
                    <div class="form-body" v-cloak>
                        @role('Administrator')
                        <div class="form-group">
                            <label class="col-md-3 control-label">Client</label>
                            <div class="col-md-9">
                                <select class="form-control selectpicker" v-model="client_id" name="client_id" data-live-search="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" v-datepicker="" name="date_pose" size="16" type="text">
                        ...
                        <div class="form-group"  v-show="commande_type == 'vitrine'">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" v-model="product_id" name="product_id" data-live-search="true"  data-language="fr">
                                    ...
                                    <div class="pharmacie_vitrines hidden cbp">
                                        <div class="cbp-item graphic" v-for="img, index in pharmacie_vitrines">
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" name="vitrines" :checked="index == 0" :value="img.vitrine" class="md-radiobtn" :id="'vitrine-'+img.vitrine">
                                            ...
                                            <div class="cbp-l-grid-projects-title uppercase text-center uppercase text-center">
                                                ...
                                                {{-- <input type="radio"  :value="img.vitrine"> --}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <button type="submit" v-on:click="markAsDraft(true)" class="btn default">Marquer comme brouillon</button>
    ...
    <script>
        $(function () {
            setTimeout(function() { 
                ...
                $('[name="client_id"]').on('changed.bs.select', function (event, clickedIndex, newValue, oldValue) {
                    ...
                    $.ajax({
                        ...
                        if(data.length == 0){
                            $('[name="product_id"]').empty()
                                    .append('<option class="bs-title-option" value>Veuillez choisir un produit</option>')
            ...
            var pharmacieModel = new Vue({
                ...
                mounted: function() {
                    $("input[name='commande_type'][value='"+this.commande_type+"']").parent('span').addClass('active checked');
                ...
                methods: {
                    ...
                    checkAllFields: function(e){
                        @if(!is_client())
                        var client_id = $('[name="client_id"]').find("option:selected").val();
                        ...
                        if(this.commande_type == "vitrine" && (this.pharmacie_id == 0)){
                            return false;
                        }
